...
if (isset($_POST['batal']) && isset($_POST['tiket_id'])) {
    ...
    $queryCheck = mysqli_query($conn, "SELECT * FROM tiket_it_hardware WHERE id = '$tiket_id' AND user_id = '$user_id'");
    ...
    if (mysqli_num_rows($queryCheck) > 0) {
        ...
        if ($tiket['status'] == 'Menunggu' && $tiket['status_validasi'] == 'Belum Validasi') {
            ...
            $queryDelete = mysqli_query($conn, "DELETE FROM tiket_it_hardware WHERE id = '$tiket_id'");
            ...
            if ($queryDelete) {
                ...
                $pesan_telegram  = "<b>🚫 TIKET IT HARDWARE DIBATALKAN</b>\n\n";
